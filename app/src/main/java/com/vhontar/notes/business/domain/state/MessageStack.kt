package com.vhontar.notes.business.domain.state

import androidx.lifecycle.LiveData
import androidx.lifecycle.MutableLiveData
import com.vhontar.notes.util.printLogD
import kotlinx.parcelize.IgnoredOnParcel
import java.lang.IndexOutOfBoundsException

const val MESSAGE_STACK_BUNDLE_KEY = "com.vhontar.notes.business.domain.state.MessageStack"
...
class MessageStack : ArrayList<StateMessage>() {
    ...
    @IgnoredOnParcel
    val stateMessage: LiveData<StateMessage?> = _stateMessage
